...
/**
 * Created by xueyue1 on 2018/5/15.
 */
public class NaiveBayesTool {
    ...
    public static void main(String[] args) {
       ...
       // NaiveBayesTool naiveBayesTool = new NaiveBayesTool("e:/1.txt");

       // System.out.println(naiveBayesTool.naiveBayesClassificate("Rainy Cool Normal Strong"));
    }
    ...
    private int getConditionAttrName(String condition) {
        ...
        for (Map.Entry entry : attrValue.entrySet()) {
            ...
            if (valueTypes.contains(condition) && !((String) entry.getKey()).equals("PlayTennis")) {
